...
CREATE TABLE `characteristic` (
  ...
  KEY `idx_characteristic_id_classroom` (`id_classroom`),
  CONSTRAINT `characteristic_ibfk_1` FOREIGN KEY (`id_element`) REFERENCES `element` (`id`),
  CONSTRAINT `characteristic_ibfk_2` FOREIGN KEY (`id_classroom`) REFERENCES `classroom` (`id`)
